...
In this project, I have fused measurements from LiDAR and camera and track vehicles over time. I have used real-world data from the Waymo Open Dataset, detected objects in 3D point clouds and applied an extended Kalman filter for sensor fusion and tracking.
